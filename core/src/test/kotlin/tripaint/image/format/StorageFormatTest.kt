...
abstract class StorageFormatTest {
    ...
    @Nested
    inner class TransformInverses {
        @Test
        fun `transformToStorage is the inverse of transformFromStorage`() {
            val f = make()
        ...
        @Test
        fun `transformFromStorage is the inverse of transformToStorage`() {
            val f = make()
