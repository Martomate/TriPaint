...
class ImageGridColorLookupTest {
    @Test
    fun `lookup should return None if there is no image`() {
    ...
    @Test
    fun `lookup should return the correct color for the (0, 0) image`() {
        val grid = ImageGrid(16)
        val lookup = ImageGridColorLookup(grid)
    ...
    @Test
    fun `lookup should return the correct color for any image`() {
        val grid = ImageGrid(16)
        val lookup = ImageGridColorLookup(grid)
        val storage = ImageStorage.fill(16, Color.Black)
