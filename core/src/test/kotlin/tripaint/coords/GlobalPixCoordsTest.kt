...
class GlobalPixCoordsTest {
    ...
    @Test
    fun `distanceSq should be 1 for offset (+-2, 0)`() {
    ...
    @Test
    fun `distanceSq should be symmetric`() {
        for (i in 1..10) {
            for (j in 1..10) {
    ...
    @Test
    fun `cell works for bottom triangles`() {
    ...
    @Test
    fun `cell works for top triangles`() {
