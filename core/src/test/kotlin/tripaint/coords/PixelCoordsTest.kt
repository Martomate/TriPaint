...
class PixelCoordsTest {
    ...
    inner class Neighbours {
        ...
        @Test
        fun `works for upside up, upside down pixel`() {
        ...
        @Test
        fun `works for upside up, left edge`() {
            val sz = 8
        ...
        @Test
        fun `works for upside up, right edge`() {
            val sz = 8
            val yy = 3
            val xx = 2 * yy
        ...
        @Test
        fun `works for upside up, down edge`() {
            val sz = 8
            val yy = sz - 1
            val xx = 2
            val pc = PixelCoords.from(tc(xx, yy), ic(0, 0))
        ...
        @Test
        fun `works for upside down, upside down pixel`() {
        ...
        @Test
        fun `works for upside down, right edge`() {
            val sz = 8
        ...
        @Test
        fun `works for upside down, left edge`() {
            val sz = 8
            val yy = 3
            val xx = 2 * yy
        ...
        @Test
        fun `works for upside down, up edge`() {
            val sz = 8
            val yy = sz - 1
            val xx = 2
            val pc = PixelCoords.from(tc(xx, yy), ic(1, 0))
    ...
    @Nested
    inner class ToGlobal {
        @Test
        fun `scales even triangles simply`() {
            val sz = 8
        ...
        @Test
        fun `handles triangle offset for even triangles`() {
            val sz = 8
            ...
            assertEquals(
                GlobalPixCoords.from(-2 * sz + 1, 5 * sz + sz - 1 - 4),
                makeG(sz, i = Pair(-2, 5), t = Pair(1, 4))
            )
        }

        @Test
        fun `handles triangle offset for odd triangles`() {
            val sz = 8
            ...
            assertEquals(
                GlobalPixCoords.from(-5 * sz + sz - 1 - 4, -2 * sz + 3),
                makeG(sz, i = Pair(-5, -2), t = Pair(4, 3))
            )
        }
    }
    ...
    inner class Apply {
        @Test
        fun `handles the origin`() {
            val sz = 8
            testPixelCoordsApply(sz, makeP(Pair(0, 0), Pair(0, 0)))
        }

        @Test
        fun `handles the (0, 0) image`() {
            val sz = 8
