...
class MenuBarAction(
  ...
  private def makeMenuItem(
    ...
    val item =
      if (imagePath == null) new MenuItem(text)
      else new MenuItem(text, new ImageView("icons/" + imagePath + ".png"))
  ...
  private def makeButton(
    ...
    val item =
      if (imagePath == null) new Button(text)
      else new Button(null, new ImageView("icons/" + imagePath + ".png"))
    item.onAction = onAction
