...
class TheMenuBar(controls: MainStageButtons) extends MenuBar {
  ...
  private val menu_file = makeMenu(
    "File",
  ...
  private val menu_edit = makeMenu(
    "Edit",
  ...
  private val menu_organize =
    makeMenu("Organize", controls.Move.menuItem, controls.Scale.menuItem, controls.Rotate.menuItem)

  private val menu_effects = makeMenu(
    "Effects",
