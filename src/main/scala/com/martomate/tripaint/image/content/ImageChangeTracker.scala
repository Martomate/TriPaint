...
class ImageChangeTracker(init_image: ImageStorage, pool: ImagePool, saver: ImageSaver) extends ImagePoolListener with ImageStorageListener with Listenable[ImageChangeListener] {
